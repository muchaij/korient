...
<html lang="en">
  <head>
    ...
    <title>Korient - Insurance Policy Admin Ver 1.0</title>
    <!-- Google font-->
    <link href="https://fonts.googleapis.com/css?family=Rubik:400,400i,500,500i,700,700i&amp;display=swap" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Roboto:300,300i,400,400i,500,500i,700,700i,900&amp;display=swap" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/css/font-awesome.css')}}">
    <!-- ico-font-->
    <link rel="stylesheet" type="text/css" href="{{asset('assets/vendors/icofont.css')}}">
    <!-- Themify icon-->
    <link rel="stylesheet" type="text/css" href="{{asset('assets/vendors/themify.css')}}">
    <!-- Flag icon-->
  ...
  <body>
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
      ...
      <div class="page-header">
        <div class="header-wrapper row m-0">
          ...
          <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="index.html"><img class="img-fluid" src="{{asset('assets/images/logo/logo-image.png')}}')}}" alt=""></a></div>
      ...
      <div class="page-body-wrapper">
        ...
        <div class="sidebar-wrapper">
          <div>
            <div class="logo-wrapper"><a href="index.html"><img class="img-fluid for-light" src="{{asset('assets/images/logo/logo-image.png')}}" alt=""><img class="img-fluid for-dark" src="{{asset('assets/images/logo/logo-image.png')}}" alt=""></a>
                ...
                <ul class="sidebar-links" id="simple-bar">
                  ...
                  <li class="sidebar-main-title">
                    <div>
                      ...
                      <p class="lan-2">Dashboards,Manage & insights.</p>
                    </div>
                  </li>
                  <li class="sidebar-list">
                    <label class="badge badge-success"></label><a class="sidebar-link sidebar-titlee" href="#"><i data-feather="home"></i><span class="lan-3">Dashboard</span></a>
                    </li>
                    <!--<li class="sidebar-main-title">
                    <div>
                      <h6 class="lan-8">Quotation</h6>
                      <p class="lan-9">Generate/Initiate quote</p>
                    </div>
                  </li>-->
                  <li class="sidebar-list">
                    <label class="badge badge-danger">New</label><a class="sidebar-link sidebar-title" href="#"><i data-feather="box"></i><span>Quotation </span></a>
                    <ul class="sidebar-submenu">
                      <li><a href="projects.html">Generate Quote</a></li>
                      <li><a href="projectcreate.html">Create new</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list">
                    <label class="badge badge-danger"></label><a class="sidebar-link sidebar-title" href="#"><i class="feather feather-shopping-bag" data-feather="feather"></i><span>Manage Company </span></a>
                    <ul class="sidebar-submenu">
                      <li><a href="projects.html">Create Users</a></li>
                      <li><a href="projectcreate.html">Create new</a></li>
                    </ul>
                  </li>
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-12 footer-copyright text-center">
                <p class="mb-0">Copyright 2021 © Korient Insurance Merchant App </p>
              </div>
            </div>
          </div>
        </footer>
    ...
    <script src="{{asset('assets/js/theme-customizer/customizer')}}"></script>
    <!-- login js-->
    <!-- Plugin used-->
  </body>
</html>